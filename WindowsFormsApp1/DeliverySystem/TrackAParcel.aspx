...
<body>
    <form id="form1" runat="server">
        ...
        <p>
            &nbsp;</p>
        <asp:Button ID="btnGotoUpdate" runat="server" style="top: 306px; left: 799px; position: absolute; height: 21px; width: 130px" Text="Update the Order" OnClick="btnGotoUpdate_Click" />
        <asp:Button ID="btnGotoQuickQuote" runat="server" style="top: 116px; left: 799px; position: absolute; height: 21px; width: 97px" Text="Quick Quote" OnClick="btnGotoQuickQuote_Click" />
